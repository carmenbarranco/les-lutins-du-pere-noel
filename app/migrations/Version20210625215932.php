 ...
 */
final class Version20210625215932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE gift (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', receiver_id INT DEFAULT NULL, factory_gifts_id INT NOT NULL, code_id INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', description LONGTEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_A47C990DCD53EDB6 (receiver_id), INDEX IDX_A47C990D5A15ACEF (factory_gifts_id), INDEX IDX_A47C990D27DAFE17 (code_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
